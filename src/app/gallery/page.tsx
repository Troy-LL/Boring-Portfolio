...
const GALLERY_MEDIA = [
  {
    type: 'video',
    src: '/images/gallery/Research Intro Video (March 17).webm',
  ...
  {
    type: 'image',
    src: '/images/gallery/ASEAN AI Challenge Build Sprint (March 22).webp',
  ...
  {
    type: 'image',
    src: '/images/gallery/Tech A Muna AI Discussion (Januray 28).webp',
  ...
  {
    type: 'image',
    src: '/images/gallery/AI Safety Webinar (December).webp',
  ...
  {
    type: 'video',
    src: '/images/gallery/Developer camp (March 6).webm',
  ...
  {
    type: 'image',
    src: '/images/gallery/AI Workshop (Nov 30).webp',
    title: 'AI Workshop',
    date: 'Nov 30',
    colSpan: 'md:col-span-1 md:row-span-2',
  },
  {
    type: 'image',
    src: '/images/gallery/Cafe Cursor (March 14).webp',
    title: 'Cafe Cursor',
    date: 'March 14',
    colSpan: 'md:col-span-1 md:row-span-1',
  },
  {
    type: 'image',
    src: '/images/gallery/ASES @ UPSCALE (March).webp',
    title: 'ASES @ UPSCALE',
    date: 'March',
    colSpan: 'md:col-span-1 md:row-span-1',
  },
  {
    type: 'image',
    src: '/images/gallery/Developer Camp 2ND Day (March 7).webp',
  ...
  {
    type: 'image',
    src: '/images/gallery/Giro AI & Seekers (March 26).webp',
  ...
  {
    type: 'image',
    src: '/images/gallery/Developer Camp Day 3 (March 8).webp',
  ...
  {
    type: 'image',
    src: '/images/gallery/Hosted an event for Seekers Match & Hatch (Nov 13).webp',
  ...
  {
    type: 'image',
    src: '/images/gallery/Hypetribe (Oct).webp',
    title: 'Hypetribe',
    date: 'Oct',
    colSpan: 'md:col-span-1 md:row-span-2',
  },
  {
    type: 'image',
    src: '/images/gallery/Kickstart (December 3).webp',
    title: 'Kickstart',
    date: 'December 3',
    colSpan: 'md:col-span-1 md:row-span-1',
  },
  {
    type: 'image',
    src: '/images/gallery/Kickstart (February).webp',
    title: 'Kickstart',
    date: 'February',
    colSpan: 'md:col-span-1 md:row-span-1',
  },
  {
    type: 'image',
    src: '/images/gallery/Seekers Guild Monthly Meetup (Feb 22).webp',
  ...
  {
    type: 'image',
    src: '/images/gallery/Hypetribe Networking Event (Oct).webp',
  ...
  {
    type: 'image',
    src: '/images/gallery/Pre Planning ASEAN AI Build Sprint (March 21).webp',
  ...
  {
    type: 'image',
    src: '/images/gallery/Student Leader VPs and Presidents (December 1).webp',
